...
Begin VB.Form FormMainWindow 
   ...
   Begin VB.Menu MenuAbout 
      ...
      Begin VB.Menu MenuAboutAppHinttext6 
         Caption         =   "本 App 的初版诞生于　2019/7/14"
      End
   End
    ...
    Public Sub MenuSoundSwitch_Click()
        If soundswitch = True Then
            ...
            Select Case setlanguage
                ...
                Case "CHS"
                    MenuSoundSwitch.Caption = "声音 关"
                Case "JPN"
                    MenuSoundSwitch.Caption = "音声 オフ"
            End Select
            WindowsMediaPlayer1.URL = ""
        Else
            soundswitch = True
            Select Case setlanguage
                ...
                Case "CHS"
                    MenuSoundSwitch.Caption = "声音 开"
                Case "JPN"
                    MenuSoundSwitch.Caption = "音声 オン"
            End Select
            WindowsMediaPlayer1.URL = ""
        End If
    End Sub
